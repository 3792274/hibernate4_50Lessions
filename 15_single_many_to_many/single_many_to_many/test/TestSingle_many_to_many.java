package single_many_to_many.test;
...
import double_many_to_many.test.HibernateUtil;
 ...
 */
public class TestSingle_many_to_many {

	@Test//创建表结构
	public void testCreateDB(){
		Configuration cfg = new Configuration().configure("single_many_to_many/resources/hibernate.cfg.xml");
	...
	public void testDelete(){
		...
		try{
			...
			session.delete(role);     //Role中级联删除只能设置  cascade="save-update" ，
